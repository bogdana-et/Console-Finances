...
for (var i = 0; i < finances.length; i++) {
  ...
  var currentFiscalValue = month[1];
  // total over 86 months
  total += currentFiscalValue;
  ...
  if (fiscalChange > greatestFiscalIncrease[1]) {
    greatestFiscalIncrease = [month[0], fiscalChange];
  }

  //calculating greatest decrease in profits/losses
